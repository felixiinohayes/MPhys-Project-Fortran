...
!--------to be modified by the user
    ...
    integer,parameter::nkpath=3,np=600,nblocks=40,nr3=11,nk=(nkpath-1)*np+1
	integer nb
...
!------------------------------------------------------
    ...
    integer*4 i,j,k,nr,i1,i2,j1,j2,lwork,info,ik,count,ir,ir3,ir12,nr12,r3,sign,kpool,kpmin,kpmax,ecounts,ikp,ir
