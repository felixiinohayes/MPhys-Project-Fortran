...
!--------to be modified by the user
    ...
    real*8,parameter::ef= 4.18903772,a=1,emin=5,emax=10,eta1=2,eta2=0.03,TOL=0.0001,Bx=0.125
    integer*8,parameter::nblocks=7,matsize=(nblocks)**3,maxiter=100000,ishift=1,mode=1,eres=100
    integer nb
